...
Before using it, please first familiarize yourself with how parameters work in DS1MapStudio, then how to work with SmithBox. This program works as a companion to these programs, not as a replacement. 
...
To fill in the fields, use Ctrl+Click; this is better than using sliders. 
