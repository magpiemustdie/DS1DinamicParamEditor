...
{
    internal static class PtdOffsets
    {
        ...
        [Flags]
        public enum CharMapFlags : uint { DisableMapHit = 0x00000010 }

        public enum AnimData : int { PlaySpeed = 0x64 }

        public enum CharPosData : int
        {
            PosAngle = 0x4,
            PosX     = 0x10,
            PosY     = 0x14,
        ...
        public enum CharData2 : int
        {
            ...
            Class               = 0xC6,
            Physique            = 0xC7,
            WarriorSunlightPts  = 0xE5,
            DarkwraithPts       = 0xE6,
            PathOfDragonPts     = 0xE7,
            GravelordPts        = 0xE8,
            ForestHunterPts     = 0xE9,
            DarkmoonBladePts    = 0xEA,
            ChaosServantPts     = 0xEB,
            Covenant            = 0x10B,
            InventoryIdxStart   = 0x1B8,
            EquipLeft1Idx       = 0x1D4,
        ...
        public enum MenuManager : int { QuantityDefault = 0x20C, }

        public enum ChrFollowCam : int
        {
            RotX       = 0xE0,
            RotY       = 0xE4,
            RotZ       = 0xE8,
        ...
        public enum Unknown1 : int { Area = 0xA12, World = 0xA13 }
        public enum Unknown2 : int { DeathCam = 0x40 }
        public enum Unknown3 : int { MenuKick = 0x0 }
        public enum Unknown4 : int { StoredMagic = 0x1D4 }
